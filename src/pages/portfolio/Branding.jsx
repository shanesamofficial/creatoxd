...
const brandingProjects = [
  {
    ...
    description: "Complete brand identity package including logo and business card design for RaniTouch.",
    tags: ["Logo Design", "Business Card", "Brand Identity", "Corporate Design"],
  ...
  },
  {
    ...
    title: "Invenza",
    image: invenzaImage,
    category: "Pharmaceutical Branding",
    description: "Comprehensive brand identity package including logo design, business card design, and flex board design for pharmaceutical company.",
    tags: ["Logo Design", "Business Card", "Flex Board", "Pharmaceutical", "Brand Identity"],
          ...
          >
            {brandingProjects.map((item, index) => (
              ...
              >
                ...
                <div className="p-6">
                  <div className="mb-3">
                    <span className="inline-block px-3 py-1 text-xs font-medium bg-orange-500/20 text-orange-300 rounded-full border border-orange-400/30">
                      {item.category}
                    </span>
                  </div>
                  ...
                  <div className="mt-4 text-center">
                    ...
                    <div className="flex flex-wrap gap-2 justify-center">
                      {preview.tags.map((tag, tagIndex) => (
                        <span
                          key={tagIndex}
                          className="px-3 py-1 text-xs bg-orange-500/20 text-orange-300 rounded-full border border-orange-400/30"
                        >
                          {tag}
                        </span>
                      ))}
