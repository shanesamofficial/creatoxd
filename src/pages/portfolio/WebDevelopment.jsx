...
const webDevProjects = [
  {
    id: 1,
    title: "CreatoXD Website",
    image: creatoUIImage,
    category: "Web Development",
    description: "Full-stack development of CreatoXD's main website using React, featuring modern animations, responsive design, and optimized performance.",
    tags: ["React", "JavaScript", "Tailwind CSS", "Framer Motion", "Responsive Design"],
    link: "https://creatoxd.co.in",
  },
];
                  ...
                  <div className="mt-4 text-center">
                    ...
                    <div className="flex flex-wrap gap-2 justify-center">
                      {preview.tags.map((tag, tagIndex) => (
                        <span
                          key={tagIndex}
                          className="px-3 py-1 text-xs bg-blue-500/20 text-blue-300 rounded-full border border-blue-400/30"
                        >
                          {tag}
                        </span>
                      ))}
